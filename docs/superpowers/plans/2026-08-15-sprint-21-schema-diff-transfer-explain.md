...
- [x] **Step 3: Extend the capability without duplicating SQL generation**
...
- [x] **Step 4: Cover every supported `SchemaChange` variant**
...
- [x] **Step 5: Run driver and API suites, then commit**
...
- [x] **Step 1: Test the preview/apply/action lifecycle**
...
- [x] **Step 2: Verify the current reducer-only behavior fails**
...
- [x] **Step 3: Add the runtime protocol**
...
- [x] **Step 4: Wire forms and preview overlay**
...
- [x] **Step 5: Invalidate only affected catalog scopes**
...
- [x] **Step 1: Add a failing live-versus-saved diff test**
...
- [x] **Step 4: Connect source selectors, filters, refresh, and rename mapping**
...
- [x] **Step 5: Persist and import snapshots atomically**
...
- [x] **Step 1: Test partial completion and uncertain state**
...
- [x] **Step 2: Add a typed `MigrationOperation`**
...
- [x] **Step 3: Require a fresh preview before apply**
...
- [x] **Step 4: Stream statement progress and preserve a rerunnable remainder**
...
- [x] **Step 1: Test path selection and bounded streaming**
...
- [x] **Step 3: Implement the terminal-native path browser**
...
- [x] **Step 4: Stream export and import through the selected live session**
...
- [x] **Step 5: Expose truthful progress and cancellation**
...
- [x] **Step 6: Reuse the same service from CLI and TUI**
...
- [x] **Step 1: Write runner tests against temporary executable scripts**
...
- [x] **Step 2: Run and prove production fakes are insufficient**

Run: `cargo test -p dexo-app --test native_tool`

Expected: FAIL.

- [x] **Step 3: Introduce an injectable process boundary**
...
- [x] **Step 4: Secure credentials and command construction**
...
- [x] **Step 5: Implement backup and restore forms**
...
- [x] **Step 6: Add opt-in live tests**
...
- [x] **Step 1: Add migration 11 for saved plans**
...
- [x] **Step 2: Test selection, confirmation, and correlation**
...
- [x] **Step 3: Normalize complete PostgreSQL and MySQL plan trees**
...
- [x] **Step 4: Wire real views and cancellation**
...
- [x] **Step 5: Save and compare plans**
...
- [x] **Step 1: Add ignored live scenarios**
...
- [x] **Step 2: Make CI run the ignored scenarios explicitly**
...
- [x] **Step 3: Add fixture/fake regression checks**
...
- [x] Schema forms render and execute dialect-correct DDL through the chosen live session.
- [x] Schema diff compares live, saved, and imported sources and applies only a freshly reviewed plan.
- [x] Export/import streams real data with truthful progress, rejects, cleanup, and cancellation.
- [x] Backup/restore invokes real native tools without exposing secrets.
- [x] EXPLAIN uses the statement under the cursor; analyzed plans require confirmation and can be saved/compared.
- [x] No production schema, diff, transfer, or explain path creates fixture data or synthetic success.
- [x] Unit, integration, ignored-live, clippy, and formatting gates pass.
