...
impl MysqlSession {
    async fn list_catalog_children(
        ...
        let routines: Vec<mysql_async::Row> = self
            .exec_rows(
        ...
        let events: Vec<mysql_async::Row> = self
            .exec_rows(
    ...
    async fn list_table_children(
        ...
        let indexes: Vec<mysql_async::Row> = self
            .exec_rows(
        ...
        let constraints: Vec<mysql_async::Row> = self
            .exec_rows(
        ...
        let triggers: Vec<mysql_async::Row> = self
            .exec_rows(
        ...
        let partitions: Vec<mysql_async::Row> = self
            .exec_rows(
        ...
        for row in partitions {
            ...
            if let Some(method) = method {
                object = object
                    .with_attribute("driver.mysql.partition_method", serde_json::json!(method));
            }
            objects.push(object);
        }
